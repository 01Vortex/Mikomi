...
class FullscreenDanmakuSettings extends StatefulWidget {
  ...
  @override
  State<FullscreenDanmakuSettings> createState() =>
      _FullscreenDanmakuSettingsState();
}
...
class _FullscreenDanmakuSettingsState extends State<FullscreenDanmakuSettings>
  ...
  @override
  void didUpdateWidget(covariant FullscreenDanmakuSettings oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.initialConfig != widget.initialConfig) {
      setState(() => _setConfig(widget.initialConfig));
    }
  }
  ...
  void _setConfig(DanmakuConfig config) {
                      ...
                      children: [
                        ...
                        _card([
                          _switchRow(
                            ...
                            label: '顶部弹幕',
                            value: _showTop,
                            onChanged: (v) => _showTop = v,
                          ),
                          _switchRow(
                            icon: Icons.vertical_align_bottom_rounded,
                            label: '底部弹幕',
                            value: _showBottom,
                            onChanged: (v) => _showBottom = v,
                          ),
                          _switchRow(
                            icon: Icons.swap_horiz_rounded,
                            label: '滚动弹幕',
                            value: _showScroll,
                            onChanged: (v) => _showScroll = v,
                            last: true,
                          ),
                        ]),
                      ],
...
class DanmakuSettingsSidePanel extends StatefulWidget {
  ...
  @override
  State<DanmakuSettingsSidePanel> createState() =>
      _DanmakuSettingsSidePanelState();
}
...
class _DanmakuSettingsSidePanelState extends State<DanmakuSettingsSidePanel> {
  ...
  @override
  void didUpdateWidget(covariant DanmakuSettingsSidePanel oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.initialConfig != widget.initialConfig) {
      setState(() => _applyConfig(widget.initialConfig));
    }
  }

  void _applyConfig(DanmakuConfig config) {
    _fontSize = config.fontSize;
    _opacity = config.opacity;
    _area = config.area;
    _duration = config.duration;
