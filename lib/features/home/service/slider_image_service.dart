...
class SliderImageService {
  ...
  static List<HomeAnimeModel> selectTopBanners(
    List<HomeAnimeModel> items, {
    int count = 5,
  }) {
    ...
    final uniqueMap = <int, HomeAnimeModel>{};
  ...
  static double _calculateCompositeScore(HomeAnimeModel item, int slotSeed) {
